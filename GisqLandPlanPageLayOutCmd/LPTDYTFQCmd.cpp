// LPTDYTFQCmd.cpp : CLPTDYTFQCmd 的实现

#include "stdafx.h"
#include "LPTDYTFQCmd.h"
#include "LPPrintMapSetsDlg.h"

// CLPTDYTFQCmd

// STDMETHODIMP CLPTDYTFQCmd::get_Enabled(VARIANT_BOOL * bEnabled )
// {
// 	//获取"行政区"信息
...
STDMETHODIMP CLPTDYTFQCmd::OnClick()
{
