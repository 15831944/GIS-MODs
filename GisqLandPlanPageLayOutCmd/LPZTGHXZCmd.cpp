// LPZTGHXZCmd.cpp : CLPZTGHXZCmd 的实现

#include "stdafx.h"
#include "LPZTGHXZCmd.h"
#include "LPPrintMapSetsDlg.h"

// CLPZTGHXZCmd

// STDMETHODIMP CLPZTGHXZCmd::get_Enabled(VARIANT_BOOL * bEnabled )
// {
// 	//获取"行政区"信息
...
STDMETHODIMP CLPZTGHXZCmd::OnClick()
{
...
// 	}
	...
	if (spGHWorkspace != NULL /*&& spLYWorkspace != NULL*/)
	{
		...
		//CString strConfigFile = strAppPath + _T("\\data\\template\\土地利用总体规划现状图.xml");
		CString strConfigFile = strAppPath + CONFIGPATH;
		CString strSection(_T("ZTGHXZ"));
