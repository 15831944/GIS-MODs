// LPZDJSXMGHCmd.cpp : CLPZDJSXMGHCmd 的实现

#include "stdafx.h"
#include "LPZDJSXMGHCmd.h"
#include "LPPrintMapSetsDlg.h"

// CLPZDJSXMGHCmd

// STDMETHODIMP CLPZDJSXMGHCmd::get_Enabled(VARIANT_BOOL * bEnabled )
// {
	//获取"行政区"信息
...
STDMETHODIMP CLPZDJSXMGHCmd::OnClick()
{
...
// 	}
	...
	if (spGHWorkspace != NULL/* && spLYWorkspace != NULL*/)
	{
		...
		//CString strConfigFile = strAppPath + _T("\\data\\template\\土地利用重点建设项目规划图.xml");
		CString strConfigFile = strAppPath + CONFIGPATH;
		CString strSection(_T("ZDJSXMGH"));
