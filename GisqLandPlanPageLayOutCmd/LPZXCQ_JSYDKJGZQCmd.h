// LPZXCQ_JSYDKJGZQCmd.h : CLPZXCQ_JSYDKJGZQCmd 的声明
...
{
public:
	CLPZXCQ_JSYDKJGZQCmd():CBaseCommand(0,_T("建设用地空间管制区图"),_T("CLPZXCQ_JSYDKJGZQCmd"),_T("建设用地空间管制区图"),_T("建设用地空间管制区图")
		,_T("建设用地空间管制区图"),_T("建设用地空间管制区图"))
	{
	}
