// LPZXCQ_TDYTFQCmd.cpp : CLPZXCQ_TDYTFQCmd 的实现

#include "stdafx.h"
#include "LPZXCQ_TDYTFQCmd.h"
#include "LPPrintMapSetsDlg.h"

// CLPZXCQ_TDYTFQCmd

// STDMETHODIMP CLPZXCQ_TDYTFQCmd::get_Enabled(VARIANT_BOOL * bEnabled )
// {
// 	//获取"行政区"信息
...
STDMETHODIMP CLPZXCQ_TDYTFQCmd::OnClick()
{
...
// 	if (m_bstrXZQCode == NULL)return S_OK;
	...
	if (spGHWorkspace != NULL && spLYWorkspace != NULL)
	{
		...
		CString strConfigFile = strAppPath + _T("\\data\\template\\土地利用中心城区土地用途分区图.xml");
		CString strSection(_T("ZXCQ_TDYTFQ"));
		...
		strArrDatasetName.Add(_T("TDYTQ"));
