// LPZXCQ_ZTGHXZCmd.cpp : CLPZXCQ_ZTGHXZCmd 的实现

#include "stdafx.h"
#include "LPZXCQ_ZTGHXZCmd.h"
#include "LPPrintMapSetsDlg.h"

// CLPZXCQ_ZTGHXZCmd

// STDMETHODIMP CLPZXCQ_ZTGHXZCmd::get_Enabled(VARIANT_BOOL * bEnabled )
// {
// 	//获取"行政区"信息
...
STDMETHODIMP CLPZXCQ_ZTGHXZCmd::OnClick()
{
...
// 	if (m_bstrXZQCode == NULL)return S_OK;
	...
	if (spGHWorkspace != NULL && spLYWorkspace != NULL)
	{
		...
		CString strConfigFile = strAppPath + _T("\\data\\template\\土地利用中心城区总体规划现状图.xml");
		CString strSection(_T("ZXCQ_ZTGHXZ"));
