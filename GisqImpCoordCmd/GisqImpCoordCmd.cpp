// GisqImpCoordCmd.cpp : 定义 DLL 的初始化例程。
//

#include "stdafx.h"
#include "GisqImpCoordCmd.h"
#include <initguid.h>
#include "GisqImpCoordCmd_i.c"
...
class CGisqImpCoordCmdModule :
	public CAtlMfcModule
{
public:
	DECLARE_LIBID(LIBID_GisqImpCoordCmdLib);
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_GISQIMPCOORDCMD, "{6AED3F8F-CD0B-463A-9672-FC7A2CA0864E}");};

CGisqImpCoordCmdModule _AtlModule;

BEGIN_MESSAGE_MAP(CGisqImpCoordCmdApp, CWinApp)
END_MESSAGE_MAP()


// CGisqImpCoordCmdApp 构造

CGisqImpCoordCmdApp::CGisqImpCoordCmdApp()
{
	// TODO: 在此处添加构造代码，
...
// 唯一的一个 CGisqImpCoordCmdApp 对象

CGisqImpCoordCmdApp theApp;


// CGisqImpCoordCmdApp 初始化

BOOL CGisqImpCoordCmdApp::InitInstance()
{
